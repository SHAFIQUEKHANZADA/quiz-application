        ...
        <div className="flex flex-col items-center justify-start text-center gap-8">
            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="grid grid-cols-2 gap-6 items-center relative z-auto">
                    ...
                    <Link href={"/social-proof"}>
                    <div className="h-[150px] w-[150px] rounded-xl border-2 border-[#5653FE] relative">
                        <Image src={"/images/boy2.webp"} alt="Boy" width={130} height={100} className="absolute bottom-2 left-2" />
                    ...
                    <Link href={"/social-proof"}>
                    <div className="h-[150px] w-[150px] rounded-xl border-2 border-[#5653FE] relative">
                        <Image src={"/images/boy3.webp"} alt="Boy" width={130} height={100} className="absolute bottom-2 left-2" />
                    ...
                    <Link href={"/social-proof"}>
                    <div className="h-[150px] w-[150px] rounded-xl border-2 border-[#5653FE] relative">
                        <Image src={"/images/boy4.webp"} alt="Boy" width={130} height={100} className="absolute bottom-2 left-2" />
